/******************************************************************************
 * This file is a modification of TrieSET.class by Robert Sedgewick and Kevin Wayne. 
 * The modification was made by Ayrton San Joaquin.
 *
 *  An set for extended strings containing only the English Alphabet (2021), implemented  using a 26-way trie.
 *
...
public class TrieSET26 implements Iterable<String> {
    private static final int R = 26;        // 26-letter alphabet
    ...
    /**
     * Returns true if a key in the set starts with {@code prefix}.
    ...
    /**
     * Unit tests the {@code TrieSET26} data type.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) {
        TrieSET26 set = new TrieSET26();
        while (!StdIn.isEmpty()) {
 ...
 *
 *  This file is a modification of TrieSET.class, which is a part of algs4.jar. algs4.jar accompanies the textbook
 *
